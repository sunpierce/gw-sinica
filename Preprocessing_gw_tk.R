...
write_csv(combined_water_level_data, "/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/combined_water_level_data.csv")


#### Step 2: HourBlock conversion (averaged_water_level_data) ####
combined_water_level_data = read_csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/combined_water_level_data.csv")
...
# Write to csv
write_csv(averaged_data, "/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/averaged_water_level_data.csv")


#### Step 3: Triangle processing for hourly data (triangle_water_level_data) ####
triangle_df <- read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Data/gw_data_ver.2/station/Triangle_ver.2.csv") # mark the location for each triangle
water_level_df <- read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/combined_water_level_data.csv") # on an hourly basis
...
# Write to csv
write_csv(merge, "/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/triangle_water_level_data.csv")


#### Step 4: Triangle processing for HourBlock data ####
triangle_df <- read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Data/gw_data_ver.2/station/Triangle_ver.2.csv")
water_level_df <- read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/averaged_water_level_data.csv")
...
# write csv
write_csv(merge, "/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/averaged_triangle_water_level_data.csv")


#### Step 5: Triangle processing for HourBlock data for neighbor ####
tri = read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Data/gw_data_ver.2/station/averaged_neighbor_triangle_ver.2.csv")
dat = read.csv("/Users/sunpierce/Desktop/Academia Sinica/gw_project/Ver.2.1/DataTemp/averaged_triangle_water_level_data.csv")
